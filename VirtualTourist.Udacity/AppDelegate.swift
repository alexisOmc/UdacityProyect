        ...
        func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
                ...
                func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
                  ...
                  self.window = window
                        ...
                        self.window?.rootViewController = UIStoryboard(name: "TravelViewController", bundle: nil).instantiateInitialViewController()
...
var persistentContainer: NSPersistentCloudKitContainer = {
    ...
    let persistentContainer = NSPersistentCloudKitContainer(name: "VirtualTourist")
